...
export const Uppgift2 = () => {
	const [friVilja, setFriVilja] = useState('')
	...
	return (
		<div>
			...
			<h2>{friVilja}</h2>
			<input
				onChange={(event) => setFriVilja(event.target.value)}
				placeholder="Denna input skall uppdatera värdet som matas in till ditt state"
			/>
		</div>
	)
}
